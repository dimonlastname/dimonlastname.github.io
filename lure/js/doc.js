...
let HelloWorld = new Lure.Content({
    ...
    AfterBuild: function () {
        this.Select('.s1').appendChild( BuildSample(`let hello = new Lure.Content({
        Target: 'body',
        Content: \`<div class="sample hello">
                    <h2>Hello World!</h2>
                  </div>\`
    })`));
        this.Select('.s2').appendChild( BuildSample(`let hello = new Lure.Content({
    Target: 'body',
    Content: \`<div class="sample hello">
                <h2>Hello, {{Name}}!</h2>
...
// #### More Samples
let MoreSamples = new Lure.Content({
    Target: '.main-content',
    Type: 'content',
    Content: `<div class="content hello-world">
                <h2>Button click</h2>
    ...
    AfterBuild: function () {
        this.Select('.s1').appendChild( BuildSample(`new Lure.Content({
    Target: 'body',
    Content: \`<div class="sample">
                <button class="button">'{{Name}}' was clicked {{count}} times</button>
              </div>\`,
    Controller: {
    ...
    OnClick: function () {
        ...
        this.Select('.s2').appendChild( BuildSample(`new Lure.Content({
    Target: 'body',
...
// #### Self sampple menu
let MenuSample = new Lure.Content({
    Target: '.main-content',
    Type: 'content',
    ...
    AfterBuild: function () {
        this.Select('.s1').appendChild( BuildSample(`let MenuTree = new Lure.Content({
...
// ###### CONTENT CONSTRUCTOR
let ccGeneral = new Lure.Content({
    Target: '.main-content',
    Type: 'content',
    ...
    AfterBuild: function () {
        this.Select('code').innerText = `//--Lure.Content Settings--
...
let ccControl = new Lure.Content({
    Target: '.main-content',
    Type: 'content',
    ...
    AfterBuild: function () {
    this.Select('code').innerText = `let c = new Lure.Content({
    Target: 'body',
    Content: \`<div></div>\`
    Control: [
        {
...
let ccSubContent = new Lure.Content({
    Target: '.main-content',
    Type: 'content',
...
let content = new Lure.Content({
    ...
    Content: \`<div class="content"></div>\`,
    Props: function () {
        this.Child1 = new Lure.Content({
            Content: \`<div></div>\`,
            Parent: this
        });
        this.Child2 = new Lure.Content({
            Content: \`<div></div>\`,
            Parent: this
        })
    }
...
let CTemplatorMain = new Lure.Content({
    Target: '.main-content',
    Type: 'content',
    Content: `<div class="content subcontn-desc">
        <h2>Templator</h2>   
...
let CTemplatorSimpleRefresh = new Lure.Content({
    Target: '.main-content',
    Type: 'content',
    Content: `<div class="content subcontn-desc">
...
<p>Random value here is {{number}}</p>
    ...
    AfterBuild: function () {
        this.Simple.Refresh();
        this.Select('code').innerText = `let Simple = new Lure.Content({
            Target: '.preview',
            Content: \`<div class="sample">
            <h2>{{title}}</h2>
        <div class="element">
